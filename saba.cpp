...
void Model::Update(AppContext& appContext)
{
    ...
    m_mmdModel->Update();
    auto position = m_mmdModel->GetUpdatePositions();
    auto normal = m_mmdModel->GetUpdateNormals();
    auto uv = m_mmdModel->GetUpdateUVs();
